...
| POT-GPD | 0.584 ± 0.0164 | 0.646 ± 0.0192 | 0.613 ± 0.0164 | 0.429 ± 0.0124 | 0.476 ± 0.0111 | 0.343 ± 0.0087 | 2.292 ± 0.0633 | 0.352 ± 0.0111 | 0.459 ± 0.0105 | 0.713 ± 0.0121 |
...
*Note: mean ± sample SD over five independent seeds (n=5, ddof=1); bold denotes the best mean per column.*
...
| POT-GPD | 0.552 ± 0.0177 | 0.621 ± 0.0236 | 0.584 ± 0.0189 | 0.561 ± 0.0170 | 0.556 ± 0.0132 | 0.387 ± 0.0100 | 2.626 ± 0.0876 | 0.482 ± 0.0158 | 0.541 ± 0.0149 | 0.613 ± 0.0141 |
...
| POT-GPD | 0.613 ± 0.0168 | 0.671 ± 0.0172 | 0.641 ± 0.0158 | 0.399 ± 0.0093 | 0.458 ± 0.0104 | 0.322 ± 0.0083 | 2.150 ± 0.0542 | 0.316 ± 0.0088 | 0.442 ± 0.0095 | 0.749 ± 0.0111 |
...
| POT-GPD | 0.592 ± 0.0169 | 0.655 ± 0.0194 | 0.622 ± 0.0168 | 0.474 ± 0.0128 | 0.511 ± 0.0125 | 0.350 ± 0.0089 | 2.333 ± 0.0649 | 0.391 ± 0.0139 | 0.496 ± 0.0132 | 0.684 ± 0.0144 |
...
- ETTh1 and ETTh2 jointly define `2 datasets × 2 horizons × 10 metrics = 40` predefined metric cells.
- PeakFocus ranks first in `36/40 = 90%` of these cells and leads every peak-event metric.
- The four non-leading cells are global metrics: MSE and R² for ETTh1/H=336 and ETTh2/H=720.
- A concise summary is: `Across ETTh1/ETTh2 and both horizons, PeakFocus ranks first in ninety percent of the predefined metric cells.`
- This percentage applies only to the ETTh1/ETTh2 extension and is not generalized to the ELC results in the submission.

## 3. Complete Comparison with AMD (AAAI 2025) and TimeAlign (ICLR 2026)
...
| AMD (AAAI 2025) [1] | 0.671 ± 0.0179 | 0.705 ± 0.0077 | 0.688 ± 0.0233 | 0.299 ± 0.0096 | 0.401 ± 0.0082 | 0.271 ± 0.0030 | 1.861 ± 0.0481 | 0.254 ± 0.0121 | 0.403 ± 0.0191 | 0.686 ± 0.0252 |
| TimeAlign (ICLR 2026) [2] | 0.643 ± 0.0251 | 0.724 ± 0.0332 | 0.681 ± 0.0266 | <u>0.274 ± 0.0105</u> | 0.398 ± 0.0156 | 0.267 ± 0.0132 | 1.844 ± 0.0459 | <u>0.253 ± 0.0047</u> | 0.402 ± 0.0140 | 0.730 ± 0.0296 |
...
- We fit the Peak-Over-Threshold/Generalized Pareto Distribution (POT-GPD) exceedance tail on the training split.
...
| Model | Recall↑ | Precision↑ | F1↑ | TP-MSE↓ | TP-MAE↓ | BCS↓ | PIM↓ | MSE↓ | MAE↓ | R²↑ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| POT-GPD | 0.558 ± 0.0157 | 0.641 ± 0.0192 | 0.597 ± 0.0160 | 0.398 ± 0.0096 | 0.455 ± 0.0097 | 0.344 ± 0.0083 | 2.305 ± 0.0627 | 0.332 ± 0.0112 | 0.423 ± 0.0096 | 0.749 ± 0.0117 |
| **PeakFocus** | **0.741 ± 0.0253** | **0.770 ± 0.0354** | **0.756 ± 0.0341** | **0.264 ± 0.0072** | **0.378 ± 0.0166** | **0.227 ± 0.0037** | **1.652 ± 0.0351** | **0.221 ± 0.0096** | **0.351 ± 0.0115** | **0.833 ± 0.0094** |
*Note: mean ± sample SD over five independent seeds (n=5, ddof=1); bold denotes the best mean per column.*
...
| Model | Recall↑ | Precision↑ | F1↑ | TP-MSE↓ | TP-MAE↓ | BCS↓ | PIM↓ | MSE↓ | MAE↓ | R²↑ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| POT-GPD | 0.532 ± 0.0179 | 0.612 ± 0.0219 | 0.569 ± 0.0183 | 0.568 ± 0.0170 | 0.562 ± 0.0160 | 0.397 ± 0.0097 | 2.707 ± 0.0903 | 0.493 ± 0.0165 | 0.548 ± 0.0147 | 0.618 ± 0.0131 |
| **PeakFocus** | **0.748 ± 0.0304** | **0.770 ± 0.0131** | **0.759 ± 0.0366** | **0.317 ± 0.0047** | **0.415 ± 0.0066** | **0.240 ± 0.0089** | **1.712 ± 0.0727** | **0.262 ± 0.0037** | **0.382 ± 0.0127** | **0.797 ± 0.0153** |
*Note: mean ± sample SD over five independent seeds (n=5, ddof=1); bold denotes the best mean per column.*
...
| Model | Recall↑ | Precision↑ | F1↑ | TP-MSE↓ | TP-MAE↓ | BCS↓ | PIM↓ | MSE↓ | MAE↓ | R²↑ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| POT-GPD | 0.586 ± 0.0195 | 0.667 ± 0.0218 | 0.624 ± 0.0191 | 1.108 ± 0.0351 | 0.807 ± 0.0211 | 0.451 ± 0.0104 | 3.326 ± 0.1149 | 0.512 ± 0.0177 | 0.548 ± 0.0134 | 0.500 ± 0.0132 |
| **PeakFocus** | **0.719 ± 0.0122** | **0.777 ± 0.0256** | **0.747 ± 0.0119** | **0.969 ± 0.0152** | **0.758 ± 0.0243** | **0.372 ± 0.0137** | **2.600 ± 0.0388** | **0.443 ± 0.0132** | **0.482 ± 0.0233** | **0.567 ± 0.0075** |
*Note: mean ± sample SD over five independent seeds (n=5, ddof=1); bold denotes the best mean per column.*
...
| Model | Recall↑ | Precision↑ | F1↑ | TP-MSE↓ | TP-MAE↓ | BCS↓ | PIM↓ | MSE↓ | MAE↓ | R²↑ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| POT-GPD | 0.552 ± 0.0214 | 0.631 ± 0.0265 | 0.589 ± 0.0220 | 1.421 ± 0.0504 | 0.954 ± 0.0280 | 0.499 ± 0.0118 | 4.043 ± 0.1699 | 0.746 ± 0.0307 | 0.637 ± 0.0194 | 0.268 ± 0.0153 |
| **PeakFocus** | **0.712 ± 0.0269** | **0.751 ± 0.0185** | **0.731 ± 0.0286** | **1.221 ± 0.0514** | **0.870 ± 0.0421** | **0.408 ± 0.0047** | **2.996 ± 0.0453** | **0.641 ± 0.0218** | **0.554 ± 0.0260** | **0.370 ± 0.0040** |
*Note: mean ± sample SD over five independent seeds (n=5, ddof=1); bold denotes the best mean per column.*

### Findings and Rebuttal Relevance

- PeakFocus outperforms the added POT-GPD baseline in all four dataset-horizon settings.
